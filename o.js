...
(function () {
    ...
    Lampa.Listener.follow('full', function (e) {
        if (e.type == 'complite') {
            setTimeout(function () {
                $(".view--online_showy", Lampa.Activity.active().activity.render()).empty().append('<svg><use xlink:href="#sprite-play"></use></svg>&nbsp;&nbsp;Дивитись онлайн');
            }, 5);
        }
    })
        ...
        if (event.name == 'activity') {
            ...
            if (Lampa.Activity.active().component == 'full') {
                var add_ads2 = setInterval(function () {
                    ...
                    var titleText = $('.selectbox__title').text(); // Ð¡Ð¾Ð·Ð´Ð°ÐµÐ¼ Ð¿ÐµÑ€ÐµÐ¼ÐµÐ½Ð½ÑƒÑŽ Ð´Ð»Ñ Ñ‚ÐµÐºÑÑ‚Ð°
